...
public class JsonAdaptedEventTest {
    ...
    public void toModelType_validEventDetails_returnsEvent() throws Exception {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(
                VALID_TITLE, VALID_DESC, VALID_START, VALID_END);
    ...
    public void toModelType_missingTitle_throwsIllegalValueException() {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(null, VALID_DESC, VALID_START, VALID_END);
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent("Bad@Title", VALID_DESC, VALID_START, VALID_END);
        assertThrows(IllegalValueException.class, Title.MESSAGE_CONSTRAINTS, adaptedEvent::toModelType);
    }

    @Test
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(VALID_TITLE, "Bad#Desc", VALID_START, VALID_END);
    ...
    public void toModelType_missingStartTime_throwsIllegalValueException() {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(VALID_TITLE, VALID_DESC, null, VALID_END);
        assertThrows(IllegalValueException.class,
    ...
    public void toModelType_missingEndTime_throwsIllegalValueException() {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(VALID_TITLE, VALID_DESC, VALID_START, null);
        assertThrows(IllegalValueException.class,
    ...
    public void toModelType_invalidTimeRange_throwsIllegalValueException() {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(VALID_TITLE, VALID_DESC,
                "2026-03-25 1000", "2026-03-25 0900");
    ...
    public void toModelType_emptyDescription_setsOptionalEmpty() throws Exception {
        JsonAdaptedEvent adaptedEvent = new JsonAdaptedEvent(VALID_TITLE, "", VALID_START, VALID_END);
        Event event = adaptedEvent.toModelType();
