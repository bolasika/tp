...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_PHOTO);
        ...
        Optional<Photo> photo = argMultimap.getValue(PREFIX_PHOTO).isPresent()
                ? Optional.of(ParserUtil.parsePhoto(argMultimap.getValue(PREFIX_PHOTO).get()))
                : Optional.empty();
